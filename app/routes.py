...
from .utils import parse_file, min_max_normalize, z_score_normalize, l1_normalize, align, create_residual, zones_coeffs
...
def upload_file():
    for file in request.files.getlist("files"):
        if not file or not file.filename.lower().endswith(".sp"):
            continue
